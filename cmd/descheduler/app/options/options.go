...
import (
	...
	"github.com/descheduler-controller/pkg/apis/componentconfig"
//	_ "github.com/descheduler/pkg/apis/componentconfig/install"
	"github.com/descheduler-controller/pkg/apis/componentconfig/v1alpha1"
	deschedulerscheme "github.com/descheduler-controller/pkg/descheduler/scheme"
...
func (rs *DeschedulerServer) AddFlags(fs *pflag.FlagSet) {
	...
	//evict-mode limits what the targetThresholds data use,we can choose average data or highest node data
	fs.StringVar(&rs.EvictMode, "evict-mode", rs.EvictMode, "Enables average evict mode or depend on the targetThresholds,default targetThresholds")
	}
