...
IMAGE:=descheduler-controller:$(VERSION)
...
build:
	CGO_ENABLED=0 go build ${LDFLAGS} -o _output/bin/descheduler-controller github.com/kubernetes-incubator/descheduler/cmd/descheduler
